...
describe('syncTeachersProfileData', () => {
    ...
    const hookContext = buildHookContext(TEACHERS_INFO_COLLECTION, previousTeachersInfo);
    ...
    const buildTestContext = ({ teachersProfileRepository = getTeachersProfileRepository(teachersProfile, updatedTeachersProfile), } = {}) => ({
    ...
    it('should copy fields to teachersProfile', async () => {
        ...
        expect(teachersProfileRepository.fetchTeachersProfileByTeachersInfoId).calledOnceWithExactly(teachersInfo._id);
