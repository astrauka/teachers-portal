...
describe('getCurrentTeachersInfo', () => {
    ...
    const buildTestContext = ({ teachersInfoRepository = getTeachersInfoRepository(teachersInfo), usersService = getUsersService(), } = {}) => ({
    ...
    context('on info not existing', () => {
        ...
        const getTeachersInfoRepository = () => createStubInstance(TeachersInfoRepository, (stub) => {
